        ...
        <div className="fixed bottom-8 right-8 z-50 flex flex-col items-end gap-3">
            <AnimatePresence>
                {isOpen && (
                    ...
                    >
                        <button className="flex items-center gap-3 bg-white px-4 py-2 rounded-full shadow-lg border border-slate-100 text-slate-700 hover:text-primary-600 font-medium transition-colors whitespace-nowrap group">
